...
const ALL_NEWS = [
  {
    ...
    body: "Penalty444 is now open to all players. Create a free account, enter the lobby, and compete on the global leaderboard. No entry fees and no real money — skill only.",
    date: "Jun 2026",
    pinned: true,
  },
  {
